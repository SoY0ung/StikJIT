...
func isMounted() -> Bool {
    ...
    guard inet_pton(AF_INET, "10.8.0.2", &addr.sin_addr) == 1 else {
...
func mountPersonalDDI(deviceIP: String = "10.8.0.2", imagePath: String, trustcachePath: String, manifestPath: String, pairingFilePath: String) -> Bool {
